...
{
    public class CA_VariablesDumper : IDumper
    {
        ...
        public Type MemberType
        {
            get
            {
                return typeof(CA_VariableMember);
            }
        }

        public CA_VariablesDumper(XmlReader xmlReader)
        {
        ...
        public List<IMember> DumpHANAXML(string viewName)
        {
            ...
            var localVariables = xmlDocument["Calculation:scenario"]["localVariables"];
            foreach (XmlElement xmlElement in localVariables)
            {
                CA_VariableMember member = new CA_VariableMember();
